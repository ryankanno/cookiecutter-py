...
latex_documents = [
  (master_doc, '{{cookiecutter.package_name}}.tex', u'{{cookiecutter.package_name}} Documentation',
...
man_pages = [
    (master_doc, '{{cookiecutter.package_name}}', u'{{cookiecutter.package_name}} Documentation',
     [author], 1)
]
